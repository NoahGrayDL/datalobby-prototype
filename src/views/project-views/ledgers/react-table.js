;(function(global, factory) {
  ...
  function getFirstDefined() {
    for (var i = 0; i < arguments.length; i += 1) {
      if (
        typeof (arguments.length <= i ? undefined : arguments[i]) !==
        "undefined"
      ) {
  ...
  function normalizeComponent(Comp) {
    var params =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}
    var fallback =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Comp
      ...
      createClass(_class, [
        {
          ...
          value: function componentWillMount() {
            this.setStateWithData(
              this.getDataModel(this.getResolvedState(), true)
            )
          }
        },
        {
        ...
        },
        {
          ...
          value: function componentWillReceiveProps(nextProps, nextState) {
            ...
            defaultableOptions.forEach(function(x) {
              var defaultName =
                "default" + (x.charAt(0).toUpperCase() + x.slice(1))
              if (
        ...
        },
        {
          ...
          value: function setStateWithData(newState, cb) {
            ...
            if (
              ...
              Object.assign(
                newResolvedState,
                this.getSortedData(newResolvedState)
              )
            }
            ...
            if (newResolvedState.sortedData) {
              newResolvedState.pages = newResolvedState.manual
                ...
                : Math.ceil(
                    newResolvedState.sortedData.length /
                      newResolvedState.pageSize
                  )
      ...
      createClass(_class, [
        ...
        },
        {
          ...
          value: function getDataModel(newState, dataChanged) {
            ...
            var columns = newState.columns,
              ...
              pivotBy =
                _newState$pivotBy === undefined ? [] : _newState$pivotBy,
              data = newState.data,
            ...
            var expanderColumn = columns.find(function(col) {
              return (
                col.expander ||
                (col.columns &&
                  col.columns.some(function(col2) {
            ...
            if (SubComponent && !expanderColumn) {
              ...
              columnsWithExpander = [expanderColumn].concat(
                toConsumableArray(columnsWithExpander)
              )
            }

            var makeDecoratedColumn = function makeDecoratedColumn(
              column,
              parentColumn
            ) {
              var dcol = void 0
            ...
            var decorateAndAddToAll = function decorateAndAddToAll(
              column,
              parentColumn
            ) {
            ...
            if (pivotBy.length) {
              ...
              var PivotParentColumn = pivotColumns.reduce(function(
                prev,
                current
              ) {
                return (
            ...
            var addHeader = function addHeader(columns, column) {
              headerGroups.push(
                _extends({}, _this2.props.column, column, {
                  columns: columns
                })
              )
              currentSpan = []
            ...
            var accessRow = function accessRow(d, i) {
              ...
              var row =
                ((_row = {}),
                defineProperty(_row, originalKey, d),
                defineProperty(_row, indexKey, i),
                defineProperty(_row, subRowsKey, d[subRowsKey]),
                defineProperty(_row, nestingLevelKey, level),
                _row)
            ...
            if (pivotBy.length) {
              var groupRecursively = function groupRecursively(rows, keys) {
                ...
                var groupedRows = Object.entries(_.groupBy(rows, keys[i])).map(
                  function(_ref) {
                    var _ref3
                    ...
                    return (
                      (_ref3 = {}),
                      defineProperty(_ref3, pivotIDKey, keys[i]),
                      defineProperty(_ref3, pivotValKey, key),
                      defineProperty(_ref3, keys[i], key),
                      defineProperty(_ref3, subRowsKey, value),
                      defineProperty(_ref3, nestingLevelKey, i),
                      defineProperty(_ref3, groupedByPivotKey, true),
                      _ref3
                    )
                  }
                )
                ...
                groupedRows = groupedRows.map(function(rowGroup) {
                  ...
                  return _extends(
                    ...
                    defineProperty(_babelHelpers$extends, subRowsKey, subRows),
                    defineProperty(_babelHelpers$extends, aggregatedKey, true),
                    _babelHelpers$extends),
                    aggregate(subRows)
                  )
                })
        ...
        },
        {
          ...
          value: function filterData(
            ...
            if (filtered.length) {
              filteredData = filtered.reduce(function(
                filteredSoFar,
                nextFilter
              ) {
              ...
              filteredData = filteredData
                .map(function(row) {
                  ...
                  return _extends(
                    ...
                    defineProperty(
                      {},
                      _this3.props.subRowsKey,
                      _this3.filterData(
                        row[_this3.props.subRowsKey],
                        filtered,
                        defaultFilterMethod,
                        allVisibleColumns
                      )
        ...
        },
        {
          ...
          value: function sortData(data, sorted) {
            ...
            var sortedData = (this.props.orderByMethod || _.orderBy)(
              data,
              sorted.map(function(sort) {
                // Support custom sorting methods for each column
                if (sortMethodsByColumnID[sort.id]) {
                  return function(a, b) {
                    return sortMethodsByColumnID[sort.id](
                      a[sort.id],
                      b[sort.id],
                      sort.desc
                    )
                ...
                return function(a, b) {
                  return _this4.props.defaultSortMethod(
                    a[sort.id],
                    b[sort.id],
                    sort.desc
                  )
            ...
            sortedData.forEach(function(row) {
              ...
              row[_this4.props.subRowsKey] = _this4.sortData(
                row[_this4.props.subRowsKey],
                sorted,
                sortMethodsByColumnID
              )
            })
        ...
        },
        {
          ...
          value: function sortColumn(column, additive) {
            ...
            var firstSortDirection = Object.prototype.hasOwnProperty.call(
              column,
              "defaultSortDesc"
            )
              ...
              function() {
                if (isTouch) {
                  document.addEventListener(
                    "touchmove",
                    _this5.resizeColumnMoving
                  )
                  document.addEventListener(
                    "touchcancel",
                    _this5.resizeColumnEnd
                  )
  ...
  */
  ...
  var defaultProps = {
    ...
    TrGroupComponent: function TrGroupComponent(_ref2) {
      ...
      return React__default.createElement(
        "div",
        _extends(
          { className: classnames("rt-tr-group", className), role: "rowgroup" },
          rest
        ),
        children
      )
    ...
    TrComponent: function TrComponent(_ref3) {
      ...
      return React__default.createElement(
        "div",
        _extends(
          { className: classnames("rt-tr", className), role: "row" },
          rest
        ),
        children
      )
    ...
    ThComponent: function ThComponent(_ref4) {
      var toggleSort = _ref4.toggleSort,
        ...
        rest = objectWithoutProperties(_ref4, [
          "toggleSort",
          "className",
          "children"
        ])
    ...
    TdComponent: function TdComponent(_ref5) {
      var toggleSort = _ref5.toggleSort,
        ...
        rest = objectWithoutProperties(_ref5, [
          "toggleSort",
          "className",
          "children"
        ])
      return React__default.createElement(
        "div",
        _extends(
          { className: classnames("rt-td", className), role: "gridcell" },
          rest
        ),
        children
      )
    ...
    LoadingComponent: function LoadingComponent(_ref10) {
      var className = _ref10.className,
        ...
        rest = objectWithoutProperties(_ref10, [
          "className",
          "loading",
          "loadingText"
        ])
  ...
  var propTypes$1 = {
    ...
    PivotValueComponent: propTypes.oneOfType([
      propTypes.func,
      propTypes.element
    ]),
    AggregatedComponent: propTypes.oneOfType([
      propTypes.func,
      propTypes.element
    ]),
  ...
  var ReactTable = (function(_Methods) {
    ...
    function ReactTable(props) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (ReactTable.__proto__ || Object.getPrototypeOf(ReactTable)).call(this)
      )
    ...
    createClass(ReactTable, [
      {
        ...
        value: function render() {
          ...
          var hasFilters =
            filterable ||
            allVisibleColumns.some(function(d) {
              return d.filterable
            })
            ...
            return [
              rows.map(function(row, i) {
                ...
                if (rowWithViewIndex[subRowsKey] && _.get(expanded, newPath)) {
                  var _recurseRowsViewIndex = recurseRowsViewIndex(
                    rowWithViewIndex[subRowsKey],
                    newPath,
                    index
                  )

                  var _recurseRowsViewIndex2 = slicedToArray(
                    _recurseRowsViewIndex,
                    2
                  )
          ...
          var rowMinWidth = _.sum(
            allVisibleColumns.map(function(d) {
              var resizedColumn =
                resized.find(function(x) {
                  return x.id === d.id
                }) || {}
          ...
          var rootProps = _.splitProps(
            getProps(finalState, undefined, undefined, this)
          )
          var tableProps = _.splitProps(
            getTableProps(finalState, undefined, undefined, this)
          )
          var tBodyProps = _.splitProps(
            getTbodyProps(finalState, undefined, undefined, this)
          )
          var loadingProps = getLoadingProps(
            finalState,
            undefined,
            undefined,
            this
          )
          var noDataProps = getNoDataProps(
            finalState,
            undefined,
            undefined,
            this
          ...
          var makeHeaderGroup = function makeHeaderGroup(column, i) {
            ...
            var flex = _.sum(
              column.columns.map(function(col) {
            ...
            var theadGroupThProps = _.splitProps(
              getTheadGroupThProps(finalState, undefined, column, _this2)
            )
            var columnHeaderProps = _.splitProps(
              column.getHeaderProps(finalState, undefined, column, _this2)
            )
          ...
          var makeHeaderGroups = function makeHeaderGroups() {
            var theadGroupProps = _.splitProps(
              getTheadGroupProps(finalState, undefined, undefined, _this2)
            )
            var theadGroupTrProps = _.splitProps(
              getTheadGroupTrProps(finalState, undefined, undefined, _this2)
            )
            return React__default.createElement(
              TheadComponent,
              _extends(
          ...
          var makeHeader = function makeHeader(column, i) {
            ...
            var theadThProps = _.splitProps(
              getTheadThProps(finalState, undefined, column, _this2)
            )
            var columnHeaderProps = _.splitProps(
              column.getHeaderProps(finalState, undefined, column, _this2)
            )
            ...
            var resizer = isResizable
              ? React__default.createElement(
                  ...
                  _extends(
                    ...
                    getResizerProps("finalState", undefined, column, _this2)
                  )
                )
              : null
            ...
            return React__default.createElement(
              ...
              React__default.createElement(
                ...
                {
                  className: classnames(
                    isResizable && "rt-resizable-header-content"
                  )
                },
                _.normalizeComponent(column.Header, {
                  data: sortedData,
          ...
          var makeHeaders = function makeHeaders() {
            var theadProps = _.splitProps(
              getTheadProps(finalState, undefined, undefined, _this2)
            )
            var theadTrProps = _.splitProps(
              getTheadTrProps(finalState, undefined, undefined, _this2)
            )
            return React__default.createElement(
              TheadComponent,
              _extends(
          ...
          var makeFilter = function makeFilter(column, i) {
            ...
            var theadFilterThProps = _.splitProps(
              getTheadFilterThProps(finalState, undefined, column, _this2)
            )
            var columnHeaderProps = _.splitProps(
              column.getHeaderProps(finalState, undefined, column, _this2)
            )
            ...
            var isFilterable = _.getFirstDefined(
              column.filterable,
              filterable,
              false
            )
          ...
          var makeFilters = function makeFilters() {
            var theadFilterProps = _.splitProps(
              getTheadFilterProps(finalState, undefined, undefined, _this2)
            )
            var theadFilterTrProps = _.splitProps(
              getTheadFilterTrProps(finalState, undefined, undefined, _this2)
            )
            return React__default.createElement(
              TheadComponent,
              _extends(
          ...
          var makePageRow = function makePageRow(row, i) {
            ...
            var trGroupProps = getTrGroupProps(
              finalState,
              rowInfo,
              undefined,
              _this2
            )
            var trProps = _.splitProps(
              getTrProps(finalState, rowInfo, undefined, _this2)
            )
            return React__default.createElement(
              TrGroupComponent,
              ...
              React__default.createElement(
                ...
                allVisibleColumns.map(function(column, i2) {
                  ...
                  var tdProps = _.splitProps(
                    getTdProps(finalState, rowInfo, column, _this2)
                  )
                  var columnProps = _.splitProps(
                    column.getProps(finalState, rowInfo, column, _this2)
                  )
                  ...
                  var resolvedCell = _.normalizeComponent(
                    column.Cell,
                    cellInfo,
                    value
                  )
                  ...
                  // Resolve Renderers
                  var ResolvedAggregatedComponent =
                    column.Aggregated ||
                    (!column.aggregate ? AggregatedComponent : column.Cell)
                  var ResolvedExpanderComponent =
                    column.Expander || ExpanderComponent
                  var ResolvedPivotValueComponent =
                    column.PivotValue || PivotValueComponent
                  var DefaultResolvedPivotComponent =
                    PivotComponent ||
                    function(props) {
                      return React__default.createElement(
                        "div",
                        ...
                        React__default.createElement(
                          ResolvedPivotValueComponent,
                          props
                        )
                      )
                    }
                  var ResolvedPivotComponent =
              ...
              rowInfo.subRows &&
                ...
                rowInfo.subRows.map(function(d, i) {
          ...
          var makePadColumn = function makePadColumn(column, i) {
            ...
            var tdProps = _.splitProps(
              getTdProps(finalState, undefined, column, _this2)
            )
            var columnProps = _.splitProps(
              column.getProps(finalState, undefined, column, _this2)
            )
          ...
          var makePadRow = function makePadRow(row, i) {
            ...
            var trProps = _.splitProps(
              getTrProps(finalState, undefined, undefined, _this2)
            )
            return React__default.createElement(
              TrGroupComponent,
          ...
          var makeColumnFooter = function makeColumnFooter(column, i) {
            ...
            var tFootTdProps = _.splitProps(
              getTfootTdProps(finalState, undefined, undefined, _this2)
            )
            var columnProps = _.splitProps(
              column.getProps(finalState, undefined, column, _this2)
            )
            var columnFooterProps = _.splitProps(
              column.getFooterProps(finalState, undefined, column, _this2)
            )
          ...
          var makeColumnFooters = function makeColumnFooters() {
            var tFootProps = getTfootProps(
              finalState,
              undefined,
              undefined,
              _this2
            )
            var tFootTrProps = _.splitProps(
              getTfootTrProps(finalState, undefined, undefined, _this2)
            )
            return React__default.createElement(
              TfootComponent,
              _extends(
          ...
          var makePagination = function makePagination() {
            var paginationProps = _.splitProps(
              getPaginationProps(finalState, undefined, undefined, _this2)
            )
            return React__default.createElement(
              PaginationComponent,
              _extends(
          ...
          var makeTable = function makeTable() {
            ...
            var tbodyChildren = functionalRowRendering
              ? makePageRow
              : [].concat(
                  toConsumableArray(
                  ...
                  toConsumableArray(padRows.map(makePadRow))
                )
            return React__default.createElement(
              "div",
              _extends(
